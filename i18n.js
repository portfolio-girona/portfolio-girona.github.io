(() => {
  ...
  const translations = {
    en: {
      'Portfolio profesional · Arquitectura': 'Professional Portfolio · Architecture',
      'Maestro Mayor de Obras · Estudiante de Arquitectura · Documentación técnica, visualización y desarrollo de proyectos': 'Building Construction Technician · Architecture Student · Technical documentation, visualization, and project development',
      'Ver proyectos': 'View projects',
      'Ver perfil': 'View profile',
      'Documentación técnica': 'Technical documentation',
      'Visualización 3D': '3D visualization',
      'Diseño arquitectónico': 'Architectural design',
      'Ficha profesional': 'Professional profile',
      'Enfoque': 'Focus',
      'Perfil': 'Profile',
      'Disponibilidad': 'Availability',
      'FAUD · UNC · Último año': 'FAUD · UNC · Final year',
      'Proyecto + técnica + representación': 'Design + technical development + representation',
      'MMO · Arquitectura': 'Building Construction Technician · Architecture',
      'Proceso': 'Process',
      'Del concepto al detalle': 'From concept to detail',
      'Cada proyecto integra idea, representación y resolución técnica con mirada arquitectónica.': 'Each project integrates concept, representation, and technical resolution through an architectural lens.',
      'Proyecto': 'Project',
      'Idea, programa y espacialidad': 'Concept, program, and spatial quality',
      'Detalle': 'Detail',
      'Medidas, precisión y documentación': 'Dimensions, precision, and documentation',
      'Representación': 'Representation',
      'Modelado, render y visualización': 'Modeling, rendering, and visualization',
      'Perfil profesional': 'Professional profile',
      'Foco': 'Focus',
      'Planos · Gestión · Renders': 'Drawings · Management · Renders',
      'Selección de trabajos con enfoque en proyecto arquitectónico, resolución técnica, representación y sensibilidad espacial.': 'Selection of works focused on architectural design, technical resolution, representation, and spatial sensitivity.',
      'Índice': 'Index',
